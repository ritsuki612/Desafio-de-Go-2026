    ...
    <footer className="bg-slate-950 border-t border-slate-800 mt-auto">
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/instructors" className="text-slate-400 hover:text-green-400 transition-colors">
                  {t.nav.instructors}
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/register" className="text-slate-400 hover:text-green-400 transition-colors">
                  {t.nav.register}
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-slate-800 mt-8 pt-6 text-center text-slate-500 text-sm">
          © 2026 Desafio de Go 2026. {t.footer.rights}
        </div>
      </div>
    </footer>
  );
